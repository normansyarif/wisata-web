...
@section('title', 'Wisata Jambi | Edit Slider')
						...
						<div class="more-data">
							...
							<form action="{{ route('admin.slider.update', $slider->id) }}" enctype="multipart/form-data" method="post" class="forms-sample">
								...
								<div class="more-data-data">
									...
									<h4 class="card-title mb-3">Edit Slider</h4>
									<div class="row">
										<div class="col-md-4 col-sm-12 mb-3">
											<img id="avatar-preview" src="{{ url('uploads/slider/' . $slider->foto) }}" style="width: 100%">
										...
										<div class="col-md-8 col-sm-12">
											<div class="form-group">
												<label>Title</label>
												<input value="{{ $slider->title }}" name="title" type="text" class="form-control" placeholder="Title" required>
											</div>
											<div class="form-group">
												<label>Subtitle (max 50 karakter)</label>
												<input value="{{ $slider->subtitle }}" maxlength="50" name="subtitle" type="text" class="form-control" placeholder="Subtitle" required>
											</div>
											<div class="form-group">
												<label>Warna Teks</label>
												<input id="warna" style="width: 20%; padding: 0" value="{{ $slider->warna }}" name="warna" type="color" class="form-control" placeholder="Warna Teks" required>
											</div>
										</div>
									</div>
								</div>
