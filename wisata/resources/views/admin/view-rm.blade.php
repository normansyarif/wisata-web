              ...
              <div class="more-data-data">
                ...
                <div class="row">
                  <div class="col-md-4 col-sm-12 mb-3">
                    <a target="__blank" href="{{ url('uploads/rm/' . $data->foto) }}">
                      <img id="avatar-preview" src="{{ url('uploads/rm/' . $data->foto) }}" style="width: 100%">
                    </a>
                  </div>
                ...
                <div class="more-data-next-btn row">
                  <div class="col-md-6 col-sm-12">
                    <button type="button" class="btn btn-success btn-block"
                      ...
                      " 
                    >
                      <form method="post" action="{{ route('admin.rm.accept', $data->id) }}">
                        @csrf
                      </form>
                      Terima
                    </button>
...
<div class="modal fade" id="reason-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="{{ route('admin.rm.reject', $data->id) }}">
        @csrf
