        ...
        <div class="card">
          <div class="card-body">
            <div class="more-data">
              ...
              <form method="post" action="{{ route('kendaraan.update', $item->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="more-data-data">
                  <h4 class="card-title mb-3">Data</h4>
                  <div class="row">
                    <div class="col-md-4 col-sm-12 mb-3">
                      <img id="avatar-preview" src="{{ url('uploads/kendaraan/' . $item->foto) }}" style="width: 100%">
