...
@section('title', 'Wisata Jambi | Tambah Souvenir')
        ...
        <div class="card">
          <div class="card-body">
            <div class="more-data">
              ...
              <form method="post" action="{{ route('souvenir.update', $item->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="more-data-data">
                  <h4 class="card-title mb-3">Data Souvenir</h4>
                  <div class="row">
                    <div class="col-md-4 col-sm-12 mb-3">
                      <img id="avatar-preview" src="{{ url('uploads/souvenir/' . $item->foto) }}" style="width: 100%">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <div class="form-group">
                        ...
                        <input value="{{ $item->nama }}" name="nama" type="text" class="form-control" placeholder="Nama Souvenir" required>
                      </div>
                      <div class="form-group">
                        <label>Harga</label>
                        <input value="{{ $item->harga }}" name="harga" type="text" class="form-control" placeholder="Rp. 50.000" required>
                      </div>
