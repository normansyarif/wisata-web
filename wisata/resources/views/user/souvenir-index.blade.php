			...
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
						...
						<h4 class="card-title text-success">Daftar Souvenir</h4>
						<div style="float: right; margin-bottom: 20px"><a href="{{ route('souvenir.add') }}" class="btn btn-primary"><i class="mdi mdi-plus"></i> Tambah</a></div>
								...
								<tbody>
									...
									<tr>
										<td>
											...
											@if($i->foto != null)
											<img src="{{ asset('uploads/souvenir/thumbs/' . $i->foto) }}" class="mr-2" alt="image" />
											@else
										...
										<td> 
											<a href="{{ route('souvenir.edit', $i->id) }}" class="btn btn-success btn-sm">Edit</a> 
											<a class="btn btn-danger btn-sm" href="{{ route('souvenir.delete', $i->id) }}" 
											...
											">
											Hapus
											<form method="post" action="{{ route('souvenir.delete', $i->id) }}">@csrf</form>
											</a>
										</td>
