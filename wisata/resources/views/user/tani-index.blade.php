			...
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
						...
						<div style="float: right; margin-bottom: 20px"><a href="{{ route('tani.add') }}" class="btn btn-primary"><i class="mdi mdi-plus"></i> Tambah</a></div>
								...
								<tbody>
									...
									<tr>
										<td>
											...
											@if($i->foto != null)
											<img src="{{ asset('uploads/tani/thumbs/' . $i->foto) }}" class="mr-2" alt="image" />
											@else
										...
										<td>
											<a href="{{ route('tani.edit', $i->id) }}" class="btn btn-success btn-sm">Edit</a>
											<a class="btn btn-danger btn-sm" href="{{ route('tani.delete', $i->id) }}"
											...
											">
											Hapus
											<form method="post" action="{{ route('tani.delete', $i->id) }}">@csrf</form>
											</a>
										</td>
