...
@section('title', 'Wisata Jambi | Tambah Kelompok Seni')
        ...
        <div class="card">
          <div class="card-body">
            <div class="more-data">
              ...
              <form method="post" action="{{ route('art.update', $item->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="more-data-data">
                  <h4 class="card-title mb-3">Kelompok Seni</h4>
                  <div class="row">
                    <div class="col-md-4 col-sm-12 mb-3">
                      <img id="avatar-preview" src="{{ url('uploads/art/' . $item->foto) }}" style="width: 100%">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <div class="form-group">
                        <label>Kelompok Seni</label>
                        <input value="{{ $item->nama }}" name="nama" type="text" class="form-control" placeholder="Nama Kelompok" required>
                      </div>
                      <div class="form-group">
                        <label>Jenis Kesenian</label>
                        <input value="{{ $item->jenis_kesenian }}" name="jenis-kesenian" type="text" class="form-control" placeholder="Jenis Kesenian" required>
                      </div>
