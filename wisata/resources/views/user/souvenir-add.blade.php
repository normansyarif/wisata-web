        ...
        <div class="card">
          <div class="card-body">
            <div class="more-data">
              ...
              <form method="post" action="{{ route('souvenir.insert') }}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <div class="form-group">
                        ...
                        <input name="nama" type="text" class="form-control" placeholder="Nama Souvenir" required>
                      </div>
                      <div class="form-group">
                        <label>Harga</label>
                        <input name="harga" type="text" class="form-control" placeholder="Rp. 50.000" required>
                      </div>
