        ...
        <div class="card">
          <div class="card-body">
            <div class="more-data">
              ...
              <form method="post" action="{{ route('art.insert') }}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                      <div class="form-group">
                        ...
                        <input name="nama" type="text" class="form-control" placeholder="Nama Kelompok" required>
                      </div>
                      <div class="form-group">
                        <label>Jenis Kesenian</label>
                        <input name="jenis-kesenian" type="text" class="form-control" placeholder="Jenis Kesenian" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="deskripsi" style="height: 100px" placeholder="Deskripsi" required></textarea>
                      </div>
