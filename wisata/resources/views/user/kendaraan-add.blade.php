...
@section('title', 'Wisata Jambi | Tambah Data')
        ...
        <div class="card">
          <div class="card-body">
            <div class="more-data">
              ...
              <form method="post" action="{{ route('kendaraan.insert') }}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <input id="latlng" name="latlng" type="text" class="form-control" placeholder="Lat, Long">
                      </div>
                      <div class="form-group">
                        <label>Wilayah</label>
